...
import configurablethreadpool.ResizableCapacityLinkedBlockQueue;
...
public class ThreadChangeResizeDemo {
    ...
    private static ThreadPoolExecutor buildTHreadPoolExecutor() {
        return new ThreadPoolExecutor(2, 5, 60, TimeUnit.SECONDS, new ResizableCapacityLinkedBlockQueue<>(10),
